...
const initialState = {
  ...
  [LAYOUT_FIELDS.RIGHT_SIDEBAR_VISIBLE]: true,
  [LAYOUT_FIELDS.RIGHT_SIDEBAR_CONTENT]: RIGHT_SIDEBAR_CONTENT.PUBLISHING,
...
const uiReducer = (state = initialState, action) => {
  ...
  switch(action.type) {
    ...
    case SET_RIGHT_SIDEBAR_VISIBILITY:
      return Object.assign({}, state, {
        [LAYOUT_FIELDS.RIGHT_SIDEBAR_VISIBLE]: action.payload,
      })
